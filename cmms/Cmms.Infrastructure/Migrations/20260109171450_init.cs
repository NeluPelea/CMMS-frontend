        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StopAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    DurationMinutes = table.Column<int>(type: "integer", nullable: true),
                    PmPlanId = table.Column<Guid>(type: "uuid", nullable: true),
                    ExtraRequestId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
