...
namespace Cmms.Infrastructure.Migrations
{
    ...
    [Migration("20260214131005_AddExtraJobOwnershipAndPersonUserMapping")]
    partial class AddExtraJobOwnershipAndPersonUserMapping
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cmms.Domain.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 2, 14, 13, 10, 1, 423, DateTimeKind.Unspecified).AddTicks(6814), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "19"
                        },
                        new
                        {
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 2, 14, 13, 10, 1, 423, DateTimeKind.Unspecified).AddTicks(6820), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "4.950000"
                        },
                        new
                        {
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 2, 14, 13, 10, 1, 423, DateTimeKind.Unspecified).AddTicks(6821), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "4.600000"
                        });
                });
            ...
            modelBuilder.Entity("Cmms.Domain.PmPlanExecutionLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("pm_plan_execution_logs", (string)null);
                });
            ...
            modelBuilder.Entity("Cmms.Domain.WorkOrder", b =>
                {
                    ...
                    b.HasIndex("PmPlanId", "ScheduledForUtc")
                        .IsUnique()
                        .HasFilter("\"PmPlanId\" IS NOT NULL AND \"ScheduledForUtc\" IS NOT NULL");
